...
###############################################################################
    ...
    **grouping_distance**
    ...
    def __call__(self,ccs):
        ...
        is stored in the glyphs.

        How the classification is done is controlled by the following attributes
        of ``ClassifyCCs``:
...
#####################################################################################
    ...
    def segment(self):
        ...
        self.order_lines()
        self.lines_to_chars()
        if self.classify_ccs is not None:
